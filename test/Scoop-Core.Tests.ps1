...
Describe 'Format Architecture String' -Tag 'Scoop' {
    It 'should keep correct architectures' {
        ...
        Format-ArchitectureString 'x64-v4' | Should -Be '64bit-v4'
        Format-ArchitectureString 'x64_v4' | Should -Be '64bit-v4'
        ...
        Format-ArchitectureString 'x64-v3' | Should -Be '64bit-v3'
        Format-ArchitectureString 'x64_v3' | Should -Be '64bit-v3'
        ...
        Format-ArchitectureString 'sse4-2' | Should -Be '64bit-v2'
        Format-ArchitectureString 'amd64-v2' | Should -Be '64bit-v2'
        Format-ArchitectureString 'amd64_v2' | Should -Be '64bit-v2'
        Format-ArchitectureString 'x64-v2' | Should -Be '64bit-v2'
        Format-ArchitectureString 'x64_v2' | Should -Be '64bit-v2'
        Format-ArchitectureString 'x86_64-v2' | Should -Be '64bit-v2'
        Format-ArchitectureString 'x86-64_v2' | Should -Be '64bit-v2'

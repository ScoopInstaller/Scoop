...
# get core functions
$core_url = 'https://github.wuyanzheshui.workers.dev/lukesampson/scoop/raw/master/lib/core.ps1'
...
# download scoop zip
$zipurl = 'https://github.wuyanzheshui.workers.dev/lukesampson/scoop/archive/master.zip'
...
$zipurl = 'https://github.wuyanzheshui.workers.dev/ScoopInstaller/Main/archive/master.zip'

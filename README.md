...
* **Installs to ~/appdata/local/ by default** You can set up your own programs and not worry that they'll interfere with other users' programs (or theirs with yours). You can optionally choose to install programs system-wide if you have admin rights.
...
* **Simpler than packaging** Scoop isn't a package manager, rather it reads JSON manifests that describe how to install a program and it's dependencies. See a [simple example](https://github.com/lukesampson/scoop/blob/master/bucket/runat.json), and [something slightly more complex](https://github.com/lukesampson/scoop/blob/master/bucket/git.json).
